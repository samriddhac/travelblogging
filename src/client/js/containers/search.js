...
import { searchCity, goToPlace, removeListItem, saveFav, showMobileMap } from '../actions/index';
...
export default connect(mapStateToProps, {searchCity, goToPlace, removeListItem, saveFav, showMobileMap})(Search);